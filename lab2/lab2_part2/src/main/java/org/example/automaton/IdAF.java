        ...
        for (char c : sequence.toCharArray()) {
            ...
            for (Tranzitie t : tranzitii) {
                if (t.getStareInitiala().equals(stareInitiala)) {
                    if (t.getValoare().equals("letter") && letters.contains(cs)) {
                        nextChar = t.getStareFinala();
                        break;
                    }
                }
                if (!t.getStareInitiala().equals(stareInitiala) && t.getValoare().equals("digit") && digits.contains(cs) && containsLetter) {
